    ...
    <div class="row">
        ...
        <div class="col-9">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" style="margin-left:100px" id="v-pills-contacts" role="tabpanel" aria-labelledby="v-pills-contacts-tab">
                    <div class="container catalog-breadcrumbs">
                        <a href="contact.php"> Contact Us </a> 
                    </div>     
                    <div class="container mt-3" id="contacts">
                        <div class="faq-text" style= "font-size: 16px"id="contact-text"> Looking for product support? HEIIIII Get in touch with us! </div>
                        <br>
                        <div class="row mb-3">
                            <div class="col-1">
                        ...
                        <div class="row mb-3">
                            <div class="col-1">
                            <i class="fas fa-map-marked i-yellow"></i>
                            </div>
                            <div class="col-8 contact-details">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <p>We sell books of various categoies in English language.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                            <div class="panel-body">
                                                <p>Yes! We ship our books all around Greece.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
