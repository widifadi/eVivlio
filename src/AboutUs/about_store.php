...
<div class="container">
    ...
    <div class="text mb-2 about-text">
        &nbsp &nbsp So you are the person whi can make the world a smatter 
        place by simply enjoying your favourite books!
     </div>
     <img class="w-100" src="../assets/img/team/about.jpg" alt="Coming soon">
</div>  